...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      'dark:text-gray-100 dark:focus:bg-gray-800 dark:data-[state=open]:bg-gray-800',
      inset && 'pl-8',
      className
    )}
    {...props}
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      'dark:text-gray-100 dark:focus:bg-gray-800 dark:focus:text-gray-100',
      inset && 'pl-8',
      className
    )}
    {...props}
...
const DropdownMenuShortcut = ({
  ...
  return (
    <span
      className={cn('ml-auto text-xs tracking-widest opacity-60', 'dark:text-gray-400', className)}
      {...props}
    />
  )
}
