  ...
  <DialogPortal>
    ...
    >
      ...
      <DialogPrimitive.Close
        ...
        aria-label="Close"
        className={cn(
          'absolute right-4 top-4 rounded-md p-1 opacity-70 ring-offset-white transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 disabled:pointer-events-none',
          'data-[state=open]:bg-gray-100 data-[state=open]:text-gray-500',
          'dark:ring-offset-gray-900 dark:data-[state=open]:bg-gray-800 dark:data-[state=open]:text-gray-300'
        )}
      >
        <X className="h-4 w-4" />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn('text-lg font-semibold leading-none tracking-tight text-primary-600 dark:text-primary-400', className)}
    {...props}
  />
))
